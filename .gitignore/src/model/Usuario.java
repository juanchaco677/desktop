...
public class Usuario {	
	...
	public Usuario(Registro registro){
	 ...
	 public String getnombreCompleto(){
		 return  this.nombreUno+" "+(esVacio(this.nombreDos)?"":this.nombreDos)+" "+(esVacio(this.apellidoUno)?"":this.apellidoUno)+" "+(esVacio(this.apellidoDos)?"":this.apellidoDos);
     }
	 
	 private boolean esVacio(String cadena) {
		 return "".equals(cadena) && cadena ==null;
	 }
